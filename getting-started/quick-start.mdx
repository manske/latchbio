---
title: "Quick Start"
description: "Get up and running with your first workflow in Python. In this quickstart, you install the Latch SDK and register a workflow to sort and assemble COVID genomes. The workflow makes use of two computational tools, SAM tools and bowtie, which will allow us to reconstruct the COVID genome from its reads."
---
...
- Understand [how to author your own workflow](/getting-started/authoring-your-workflow).
- Understand [how to test and debug your workflow](/testing-and-debugging-a-workflow/development-and-debugging).
- Read the [Concepts](/defining-a-workflow/what-is-a-workflow) page
- Visit [Examples](/examples/workflows-examples) to see real-world bioinformatics workflows being built using Latch SDK
