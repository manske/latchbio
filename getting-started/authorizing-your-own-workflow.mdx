...
This document aims to be an extension to the [Quickstart](/getting_started/quick-start) to help you better understand the structure of a workflow and write your own.

**Prerequisite:**

- Complete the [Quickstart](/getting_started/quick-start) guide.
