...
description: "The Latch SDK supports first-class static typing. All input parameters and output values must be annotated with types in the function signature. These type annotations validate task values and guide the construction of parameter-specific frontend components when your interface is generated at registration."
---
...
![The user interface that corresponds to the int type](/images/int.png)
...
![The user interface that corresponds to the Boolean type](/images/boolean.png)
...
![The user interface that corresponds to the str type](/images/str.png)
...
![The user interface that corresponds to the LatchFile type](/images/optional-latch-file.png)
...
![The user interface that corresponds to the LatchDir type](/images/latchdir.png)
...
![The user interface that corresponds to the Enum type](/images/enum.png)
...
![The user interface that corresponds to the List type](/images/list.png)
...
![The user interface that corresponds to a list of dataclasses](/images/dataclass.png)
