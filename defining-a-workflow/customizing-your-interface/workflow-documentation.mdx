...
description: "While most of the metadata of a workflow will be encapsulated in a LatchMetadata object, we still require a docstring in the body of the workflow function which specifies both a short and long-form description."
---
...
![A short description of the workflow displayed under the workflow name once the workflow is published](/images/one-line-description.png)
...
![Workflow "About" tab displaying the workflow description from the example above](/images/long-form-description.png)
