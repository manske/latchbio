...
description: "Latch dynamically constructs the workflow interface based on the workflow function code and the `LatchMetadata` object."
---

With these, you can specify

<Card
  title="The contact email, repository, social media links, etc."
  icon="mailbox"
  iconType="duotone"
></Card>
<Card
  title="The ordering and grouping of parameters"
  icon="object-group"
  iconType="duotone"
></Card>
<Card
  title="parameter tooltip descriptions"
  icon="toolbox"
  iconType="duotone"
></Card>
<Card
  title="parameter display names"
  icon="display-code"
  iconType="duotone"
></Card>
