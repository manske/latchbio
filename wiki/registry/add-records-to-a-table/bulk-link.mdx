...
<Note>
    Note that Registry CSV import only supports **.csv** at the moment. If you have an Excel file (.xls, .xlsx) or text file (.txt), please make sure to save them as a CSV first. 
</Note>
...
![](/images/bulk-import-6.png)
    ...
    **Pro-tip:** If you want to import a CSV with new columns and one of the columns contains values that match record names in the Registry, the columns and their values will be linked with those records automatically.
</Note>