...
Visit the [learning through An Example](/examples/workflow-examples) page to see an end-to-end flow of how to use `latch develop` to test and debug a simple variant calling pipeline.
